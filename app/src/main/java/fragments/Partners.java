...
public class Partners extends Fragment {
    ...
    public static Partners newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_partners, null);
        v.findViewById(R.id.barcelona).setOnClickListener(new View.OnClickListener() {
            @Override
